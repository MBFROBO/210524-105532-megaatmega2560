...
ServoSmooth servos[7];
uint16_t servo_speed_control(uint16_t _targetPos, uint16_t _basePos) {
    if (_targetPos > _basePos) {
        _basePos++;
    }
    if (_targetPos < _basePos) {
        _basePos--;
...
void head_control(uint8_t data[], uint8_t state[]) {
    ...
    servos[2].setSpeed(10);
    servos[3].setSpeed(10);


    servos[0].setTargetDeg(data[0]);
    servos[1].setTargetDeg(data[1]);
    servos[2].setTargetDeg(data[2]);
    servos[3].setTargetDeg(data[3]);
...
void neck_control(uint8_t data[], uint8_t state[]) {
    ...
    servos[4].setSpeed(10);
    servos[5].setSpeed(10);
    servos[6].setSpeed(10);


    servos[4].setTargetDeg(data[0]);
    servos[5].setTargetDeg(data[1]);
    servos[6].setTargetDeg(data[2]);
